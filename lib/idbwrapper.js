/** Wrapper for IndexedDB. Extension of idbstore.js*/
define(function(require, exports, module){
  ...
  IDBWrapper.prototype = {
    ...
    /**
     * Perform the updates in the update array on a record in the store 
     * selected by key.
     *
     * @param{String} key The key of the document to update
     * @param{Array} update An array of updates as generated by
     *  {@link IDBUpdateFactory}.
     * @param{Function} onSuccess Success callback
     * @param{Function} onError Error callback
     * @param{Object} transaction (optional) The IndexedDB transaction to use
     *  for the updates
     * @param{String} storeName (optional) The name of the object store to query
     *  for the document to be updated. Will use this.storeName() if not
     *  provided
     */
    ...
    // Delegations to IDBStore (idbstore.js)
    consts: function(){
