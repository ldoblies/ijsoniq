define(function(require, exports, module){
  ...
  var objectdiff = require('./objectDiff').diff;
  ...
  IDBWrapper.prototype = {
    ...
    update: function(key, update, onSuccess, onError, transaction, storeName){
      ...
      var onGetSuccess = function(obj){
        if (!obj){
          // TODO for some updates (e.g. deletion) this should return success?
        ...
        if (_self.store.keyPath !== null){
          // Inline keys
          if (!Utils.set(obj, _self.store.keyPath, key)){
    ...
    applyUpdate: function(obj, upd){
      switch (upd.type){
        case this.updConstants.SET:
          return Utils.set(obj, upd.key, upd.val);
  ...
  var IDBUpdateFactory = exports.IDBUpdateFactory = {
    /** Set 'key' to 'value' (overwrites key if already present) */
    setUpdate: function(key, value){
      return {
